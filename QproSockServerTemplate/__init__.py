...
name = "QproSockServerTemplate"
executable_name = "QproSockServerTemplate"

from .__config__ import *

config: QproSockServerTemplateConfig = None
if enable_config:
    config = QproSockServerTemplateConfig()

import sys
from QuickProject import QproDefaultStatus, user_pip, _ask, external_exec, QproDefaultStatus
